...
''
  ...
  @define-color headerbar_border_color rgba(${config.theme.base01}, ${config.theme.base01}, ${config.theme.base01}, 0.7);
  @define-color headerbar_backdrop_color @window_bg_color;
  @define-color headerbar_shade_color rgba(0, 0, 0, 0.07);
  @define-color headerbar_darker_shade_color rgba(0, 0, 0, 0.07);
  @define-color sidebar_bg_color #${config.theme.base01};
  @define-color sidebar_fg_color #${config.theme.base07};
  ...
  @define-color dialog_fg_color #${config.theme.base07};
  ...
  @define-color light_1 #${config.theme.base07};
  @define-color light_2 #${config.theme.base07};
  @define-color light_3 #${config.theme.base07};
  @define-color light_4 #${config.theme.base07};
  @define-color light_5 #${config.theme.base07};
  @define-color dark_1 #${config.theme.base07};
  @define-color dark_2 #${config.theme.base07};
  @define-color dark_3 #${config.theme.base07};
  @define-color dark_4 #${config.theme.base07};
  @define-color dark_5 #${config.theme.base07};
''
