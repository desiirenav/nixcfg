  ...
  hjem.users.narayan.files = {
    ".config/vesktop/themes/base16.css".text = ''
      ...
      .theme-light.theme-light, .theme-dark.theme-dark {
        ...
        --modal-footer-background: var(--base00);
        ...
        --background-message-hover: var(--base00);
        --background-modifier-accent: var(--base00);
        --background-modifier-hover: var(--base00);
        --background-modifier-active: var(--base00);
