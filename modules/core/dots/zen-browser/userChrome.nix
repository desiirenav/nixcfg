...
''
  :root {
    ...
    --lwt-text-color: #${config.theme.base05} !important;
    --toolbar-field-color: #${config.theme.base05} !important;
    --tab-selected-textcolor: #${config.theme.base05} !important;
    --toolbar-field-focus-color: #${config.theme.base05} !important;
    --toolbar-color: #${config.theme.base05} !important;
    --newtab-text-primary-color: #${config.theme.base05} !important;
    --arrowpanel-color: #${config.theme.base05} !important;
    --arrowpanel-background: #${config.theme.base00} !important;
    --sidebar-text-color: #${config.theme.base05} !important;
    --lwt-sidebar-text-color: #${config.theme.base05} !important;
  ...
  #permissions-granted-icon {
    color: #${config.theme.base05} !important;
  }
