...
''
  ...
  @-moz-document url-prefix("about:") {
    :root {
      --in-content-page-color: #${config.theme.base05} !important;
  ...
  @-moz-document url("about:newtab"), url("about:home") {
    ...
    :root {
      ...
      --newtab-wordmark-color: #${config.theme.base05} !important;
  ...
  @-moz-document url-prefix("about:preferences") {
    :root {
      ...
      --in-content-text-color: #${config.theme.base05} !important;
  ...
  @-moz-document url-prefix("about:protections") {
    :root {
      ...
      --in-content-primary-button-text-color-hover: #${config.theme.base05} !important;
      --in-content-primary-button-background: #${config.theme.base03} !important;
      --in-content-primary-button-text-color: #${config.theme.base05} !important;
    }
