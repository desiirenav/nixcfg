...
''
  ...
  @define-color dark_1 #${config.theme.base00};
  @define-color dark_2 #${config.theme.base00};
  @define-color dark_3 #${config.theme.base00};
  @define-color dark_4 #${config.theme.base00};
  @define-color dark_5 #${config.theme.base00};
''
